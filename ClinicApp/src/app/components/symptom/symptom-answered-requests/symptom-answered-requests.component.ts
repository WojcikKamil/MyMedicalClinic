...
@Component({
  selector: 'app-symptom-answered-requests',
  templateUrl: './symptom-answered-requests.component.html',
  styleUrls: ['./symptom-answered-requests.component.scss']
})
export class SymptomAnsweredRequestsComponent implements OnInit {
  ...
  getRequests(){
    this.symptom$ = this.symptomService.getAnsweredSymptomRequest();
    }
